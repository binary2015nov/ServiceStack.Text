...
//            })
//            {
//                Assert.That(HttpUtils.GetStringFromUrl(ExampleGoogleUrl), Is.EqualTo("mocked"));
...
//            })
//            {
//                Assert.That(await HttpUtils.GetStringFromUrlAsync(ExampleGoogleUrl), Is.EqualTo("mocked"));
